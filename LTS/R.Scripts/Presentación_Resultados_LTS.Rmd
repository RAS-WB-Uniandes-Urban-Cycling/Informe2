...
load(paste0(ruta_resultados,"Modelo_Análisis_Estadístico_LTS.Rdata"))
load(paste0(ruta_resultados,"Capa_Calculo_Logit.Rdata"))
...
capa_LTS_estimado <- mutate(Capa_Variables_Prediccion, LTS_Estimado=ifelse(X4>=0.5,4,ifelse(X3>=0.5,3,ifelse(X2>0.5,2,1))))
