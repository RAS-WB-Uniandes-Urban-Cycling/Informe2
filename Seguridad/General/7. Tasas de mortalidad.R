...
AccidentesBiciTotal$Gravedad2<-ifelse(AccidentesBiciTotal$Gravedad=="MUERTO"|AccidentesBiciTotal$Gravedad=="Muerta"|AccidentesBiciTotal$Gravedad=="MUERTA","Dead","Not dead")
AccidentesBiciTotal$Gravedad2<-ifelse(!is.na(AccidentesBiciTotal$Fallece),ifelse(AccidentesBiciTotal$Fallece==1,"Dead",AccidentesBiciTotal$Gravedad2),AccidentesBiciTotal$Gravedad2)
...
####### Calculo de las tosas de mortalidad para toda bogota - estimado de poblacion oficial (Sexo y grupos de edad - No localidad)----
...
TasasMortalidad_bogota<-Agregado_bogota %>% select(FECHA,GR_EDAD,DEFUNCIONES,SEXO,ASDRbog)
...
####### Calculo de las tosas de mortalidad para toda bogota - estimado de poblacion propuesto (Sexo y grupos de edad - No localidad)----
...
####### Calculo de las tosas de mortalidad para toda bogota (Sexo, grupos de edad y localidad)----
...
Agregado_localidad<-merge(Agregado_localidad,TasasMortalidad_bogota,by=c("FECHA","SEXO","GR_EDAD"),all.x=TRUE)
...
# Agregación de los valores de muertes esperadas en las tasas de mortalidad
WorkTable_localidad<-aggregate(Agregado_localidad[,c("DEFUNCIONES","POBLACION","MUERTES","Exp","BICIUSRSINT","ADRbic","VarBic")],by=list(Agregado_localidad$FECHA,Agregado_localidad$SEXO,Agregado_localidad$LOCALIDAD),FUN=sum)
names(WorkTable_localidad)[1:3]<-c("FECHA","SEXO","LOCALIDAD")
rm(Agregado_localidad)
WorkTable_localidad$CDRbog<-(WorkTable_localidad$DEFUNCIONES/WorkTable_localidad$POBLACION)*100000
WorkTable_localidad$CDRbic<-(WorkTable_localidad$MUERTES/WorkTable_localidad$BICIUSRSINT)*100000
WorkTable_localidad$CDRbic[is.nan(WorkTable_localidad$CDRbic)]<-0
WorkTable_localidad$CDRbic[is.infinite(WorkTable_localidad$CDRbic)]<-0
WorkTable_localidad$SMRbic_bog<-WorkTable_localidad$MUERTES/WorkTable_localidad$Exp
WorkTable_localidad$SMRbic_bog[is.nan(WorkTable_localidad$SMRbic_bog)]<-0
WorkTable_localidad$SMRbic_bog[is.infinite(WorkTable_localidad$SMRbic_bog)]<-0
WorkTable_localidad$IADRbic_bog<-WorkTable_localidad$CDRbog*WorkTable_localidad$SMR

#Almacenamiento de las tasas de mortalidad----
save(WorkTable_bogota_of, WorkTable_bogota_prop,file=paste0(carpetaRAS,"/RESULTADOS/SEGURIDAD/Bases de datos/7. MortalityRates_SexEdad.Rdata"))
save(WorkTable_localidad,file=paste0(carpetaRAS,"/RESULTADOS/SEGURIDAD/Bases de datos/7. MortalityRates_SexEdadLocalidad.Rdata"))

#----
plot(WorkTable_bogota_of[WorkTable_bogota_of$SEXO=="Male",]$ADRbog,type="l",col="blue")
lines(WorkTable_bogota_prop[WorkTable_bogota_prop$SEXO=="Male",]$ADRbog,type="l",col="red")

plot(WorkTable_bogota_of[WorkTable_bogota_of$SEXO=="Male",]$IADRbic_bog,type="l",col="blue")
lines(WorkTable_bogota_prop[WorkTable_bogota_prop$SEXO=="Male",]$IADRbic_bog,type="l",col="red")

plot(WorkTable_localidad[WorkTable_localidad$LOCALIDAD=="FONTIBON"&WorkTable_localidad$SEXO=="Male",]$ADRbic,type="l",col="red")
lines(WorkTable_bogota_of[WorkTable_bogota_of$SEXO=="Male",]$ADRbog,type="l",col="blue")
